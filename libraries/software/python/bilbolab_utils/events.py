...
# ======================================================================================================================
class EventListener:
    def __init__(self, event: Condition, callback, once=False, finished_callback=None):
        """
        ...
        """
        assert (isinstance(event, Condition))
    ...
    def _execute_callback(self):
        try:
            self.callback()  # Execute the main callback
        finally:
            if self.finished_callback:
                self.finished_callback()  # Execute the finished callback, if provided
