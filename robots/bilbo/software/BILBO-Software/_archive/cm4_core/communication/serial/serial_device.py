...
from _archive.cm4_core_old2.communication.serial.core.serial_socket import UART_Socket
from _archive.cm4_core_old2.communication.serial.protocols.uart_protocol import UART_Protocol
