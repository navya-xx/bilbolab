...
uint8_t testfunction(test_struct s){
	return 1;
}

core_utils_RegisterEntry<uint8_t, test_struct> test_reg_entry(&register_map, 0x55, testfunction);
...
//    rc_rgb_led_side_2.setColor(0, 0, 100);
//    rc_rgb_led_side_2.state(1);
