...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, LED2_Pin|NEW_SAMPLES_OUTPUT_Pin|LED1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, MOTOR_RIGHT_DIR_Pin|MOTOR_LEFT_DIR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(CS_IMU_GPIO_Port, CS_IMU_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, CONTROL_TASK_TICK_Pin|RS485_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : NEW_SAMPLES_OUTPUT_Pin */
  GPIO_InitStruct.Pin = NEW_SAMPLES_OUTPUT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(NEW_SAMPLES_OUTPUT_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : CONTROL_TASK_TICK_Pin RS485_EN_Pin */
  GPIO_InitStruct.Pin = CONTROL_TASK_TICK_Pin|RS485_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
