...
from core.communication.serial.protocols.uart_protocol import UART_Message
from core.communication.serial.serial_connection import UART_Socket, SerialConnection
