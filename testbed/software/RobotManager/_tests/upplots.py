...
# ------------------------------------------------------------------------------
# Top-level callback functions (they must be defined at module level for pickling)
def updatable_plot_closed_callback():
    print("UpdatablePlot: Plot window closed callback triggered.")


def realtime_plot_closed_callback():
    print("RealTimePlot: Plot window closed callback triggered.")
...
def testUpdatablePlot():
    ...
    up.callbacks.close.register(function=updatable_plot_closed_callback)
...
def testRealTimePlot():
    ...
    rt.callbacks.close.register(function=realtime_plot_closed_callback)
    rt.start()
