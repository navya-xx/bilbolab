...
class JoystickWidget:
    def __init__(self, id, title, initial_x=0, initial_y=0, size=None, position=None, lockable=False, locked=False):
        self.id = id
        self.title = title
        self.x = initial_x
        self.y = initial_y
...
def example():
    ...
    # New: Add a Joystick widget example that is lockable (locked).
    joystick = JoystickWidget("joy1", "JSA", 0, 0, size=(1, 1), lockable=True, locked=True)
