...
declare module '$env/static/private' {
	...
	export const SDL_JOYSTICK_HIDAPI_PS4_RUMBLE: string;
	export const PYCHARM_UUID: string;
	...
	export const PYCHARM_PROJECT_ID: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_execpath: string;
		SDL_JOYSTICK_HIDAPI_PS4_RUMBLE: string;
		PYCHARM_UUID: string;
		PATH: string;
