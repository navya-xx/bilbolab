...
class CollisionSettings:
    ...
    includes: list[type] = dataclasses.field(default_factory=lambda: [globals()['WorldObject']])
...
class WorldObject(scheduling.ScheduledObject):
    ...
    static: bool = False
    visualization: WorldObjectVisualization

    def __init__(self,
                 object_id: str = None,
                 world: World = None,
                 group: WorldObjectGroup = None,
        ...
        Args:
            ...
            world (World): The world to which this object belongs.
            group (WorldObjectGroup): The group that contains this object.
        ...
        if self.world is not None and hasattr(self.world, 'addObject'):
...
class WorldObjectGroup(WorldObject):
    ...
    def __init__(self,
        ...
        Args:
            ...
            world (World): The world in which the group exists.
            objects (list[WorldObject]): Initial list of objects in the group.
            local_space (core_spaces.Space): The local space for the group.
        """
        super().__init__(object_id=object_id, world=world, *args, **kwargs)
    ...
    def addObject(self, object: Union[WorldObject, list[WorldObject]]):
        """
        Add one or more WorldObjects to the group.

        Args:
            object (WorldObject or list[WorldObject]): The object(s) to add.
        """
...
class World(scheduling.ScheduledObject):
    ...
    def addObject(self, objects: Union[WorldObject, list[WorldObject]]):
        """
        Add one or more WorldObjects to the world.

        Args:
            objects (WorldObject or list[WorldObject]): Object(s) to add.
        """
    ...
    def removeObject(self, objects: Union[list[WorldObject], WorldObject]):
        """
        Remove one or more objects from the world.

        Args:
            objects (WorldObject or list[WorldObject]): The object(s) to remove.
        """
        if not isinstance(objects, list):
            objects = [objects]
    ...
    def addAgent(self, agent: WorldObject):
        ...
        Args:
            agent (WorldObject): The agent to add.
        """
    ...
    def getObjectsByID(self, id: str, regex=False) -> list[WorldObject]:
        """
    ...
    def getObjectsByType(self, type_: type) -> list[WorldObject]:
        """
