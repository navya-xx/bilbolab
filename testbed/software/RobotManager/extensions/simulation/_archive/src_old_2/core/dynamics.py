...
class DynamicObject(Object, ABC):
    ...
    # === INIT =========================================================================================================
    def __init__(self, object_id, env=None, space: sp.Space=None, *args, **kwargs):
        super().__init__(object_id=object_id, env=env, space=space, *args, **kwargs)

        # Register the dynamics action in the World Dynamics Phase
        Action(action_id='dynamics', function=self.action_dynamics, object=self)

        self.addChild(self.dynamics)
